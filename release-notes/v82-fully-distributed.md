...
* Improved the text box widget in [input widgets](../app-builder/build-frontend/widgets/input-widgets.md) to support local configuration.
* Enabled reordering [functions](../app-builder/build-backend/functions.md) across different sections in the [Backend Builder](../app-builder/build-backend.md).
...
* Restored support for [Docker Extensions](../app-builder/build-backend/functions/extensions.md).
