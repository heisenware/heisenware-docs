...
* Added new `Duration` and `Interval` helper objects for JavaScript expressions within the [modifier](../app-builder/build-backend/extension-nodes/modifier.md) extension node.
...
* Fixed event-style function subscription losses that occurred when an [Agent](../app-builder/build-backend/agents.md) encountered network reconnections.
