...
* **Restructured product documentation**: Completely rebuilt and restructured the [Welcome](../welcome.md) documentation to improve readability and user navigation.
