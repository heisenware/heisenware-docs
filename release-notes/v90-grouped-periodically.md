...
* Generic and fully nested [grouping](../app-builder/build-frontend/widgets/dynamic-group.md) of widgets
* High-level [data binding to groups](../app-builder/build-frontend/widgets/dynamic-group.md#data-settings-data-bindings)
* New [Card](../app-builder/build-frontend/widgets/display-widgets/card.md) widget
