...
* **Data population:** The data output of the [`getTableData`](../../app-builder/build-backend/functions/storage/relational-database.md#gettabledata) Function binds directly to the data property of the data grid widget to populate the UI.
...
* **User feedback:** [Modifiers](../../app-builder/build-backend/extension-nodes/modifier.md) trigger on the execution of the CRUD Functions and pass adjustable strings to a [toast widget](../../app-builder/build-frontend/widgets/display-widgets/toast.md) to display immediate confirmation or error messages to the operator.
