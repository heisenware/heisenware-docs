...
* **Form data receipt:** An [`echo`](../../app-builder/build-backend/functions/utilities/data-processing.md#echo) function receives the form data. This lets the flow trigger [on page load](../../app-builder/build-backend/functions/README.md#trigger-sources) to run the connected validation routine, which enables the upload button.
