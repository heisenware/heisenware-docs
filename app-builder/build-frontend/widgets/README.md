...
3. Pick a widget property inside the function block.
...
* **Function output to widget**: A function's output (or a modifier) writes into a widget property, for example feeding a dataset into a chart or a status into a lamp. Data flows from logic to UI.
