...
2. Drag a [function](../../build-backend/functions.md) part (an input, trigger, or output) or a [modifier](../../build-backend/modifier.md) from the [Backend Builder](../../build-backend/) and drop it onto the widget.
