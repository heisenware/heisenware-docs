...
Returns the serial connector instance.
...
<table><thead><tr><th width="150">Input</th><th>Description</th><th width="100">Type</th></tr></thead><tbody><tr><td><code>baudRate</code></td><td>The new speed for the active port. Supported values include 19200 or 115200.</td><td>integer</td></tr></tbody></table>
...
Removes the connector instance from the runtime engine and clears all registered listeners.
...
Registers a stream observer to monitor incoming serial data, evaluate payloads using a selected parsing strategy, and trigger a callback function when a match occurs.
...
Returns `true` when the observer registers successfully.
