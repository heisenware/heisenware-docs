...
<table>
  ...
  <tbody>
    <tr>
      <td><code>url</code></td>
      <td>The endpoint URL of the GraphQL API.</td>
      <td>string</td>
    </tr>
    <tr>
      <td><code>document</code></td>
      <td>The GraphQL query or mutation, written in standard GraphQL syntax.</td>
      <td>string</td>
    </tr>
    <tr>
      <td><code>variables</code></td>
      <td>Optional variables required by the document.</td>
      <td>object</td>
    </tr>
    <tr>
      <td><code>headers</code></td>
      <td>Optional request headers as key-value pairs, commonly used for authentication.</td>
      <td>object</td>
    </tr>
  </tbody>
</table>
