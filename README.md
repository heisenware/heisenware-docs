...
* **Extensible**: When the built-in [functions](app-builder/build-backend/functions.md) fall short, you wrap your own code (Node.js, Python, C++) into extensions that become native functions.
